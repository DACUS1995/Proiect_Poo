#############################################################################
# Makefile for building: SimCell
# Generated by qmake (3.0) (Qt 5.4.2)
# Project:  SimCell.pro
# Template: app
# Command: C:\Qt\5.4\mingw491_32\bin\qmake.exe -spec win32-g++ -o Makefile SimCell.pro
#############################################################################
...
Makefile: SimCell.pro C:/Qt/5.4/mingw491_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.4/mingw491_32/mkspecs/features/spec_pre.prf \
